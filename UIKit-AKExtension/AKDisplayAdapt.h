...
#define AK_Main_Window    UIApplication.sharedApplication.delegate.window
#define AK_Current_Window UIApplication.sharedApplication.keyWindow
...
@interface AKDisplayAdapt : NSObject
